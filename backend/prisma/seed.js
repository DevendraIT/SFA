...
async function main() {
  ...
  const permissionsData = [
    ...
    },
    {
      ...
      slug: "territory:create",
      moduleName: "organization",
    },
    {
      name: "Update Territory",
      slug: "territory:update",
      moduleName: "organization",
    },
    {
    ...
    { name: "Read Roles", slug: "read:roles", moduleName: "roles" },
    { name: "Create Roles", slug: "create:roles", moduleName: "roles" },
    { name: "Update Roles", slug: "update:roles", moduleName: "roles" },
    { name: "Delete Roles", slug: "delete:roles", moduleName: "roles" },
    { name: "Assign Roles", slug: "assign:roles", moduleName: "roles" },

    { name: "Read Teams", slug: "read:teams", moduleName: "team" },
    { name: "Create Teams", slug: "write:teams", moduleName: "team" },
    { name: "Update Teams", slug: "update:teams", moduleName: "team" },
    { name: "Delete Teams", slug: "delete:teams", moduleName: "team" },
  ...
  console.log(
    `🔒 Seeded ${createdPermissions.length} permissions and mapped to Organization Administrator`,
  );
